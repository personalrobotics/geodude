...
class TestGraspManager:
    ...
    def test_mark_grasped_tracks_state(self, mujoco_model_and_data):
        """Marking an object as grasped tracks it in grasp state."""
        model, data = mujoco_model_and_data
        gm = GraspManager(model, data)
    ...
    def test_mark_released_clears_state(self, mujoco_model_and_data):
        """Releasing an object clears its grasp state."""
        model, data = mujoco_model_and_data
        gm = GraspManager(model, data)
    ...
    def test_mark_grasped_idempotent(self, mujoco_model_and_data):
        ...
        # Only one entry in grasped dict
